...
Geneatte a normal distribution with mean 0 and standard deviation 1

```{r}
data <- rnorm(10000, mean = 0, sd = 1)

ggplot() +
  labs(x = "random attempt", y= "randoms, μ = 0, σ = 1") +
...
ggplot() +
  ...
  geom_hline(yintercept = mean(measurements), color = "red", linetype ="solid") +
...
Unlike the "Weighting the Gold Price" example $\alpha$ is constant and depends on
